"""
Splits the DOI prediction dataset into stratified train/val/test sets (60/20/20).
Stratification is by has_doi to preserve class balance across splits.
Input:  data/90k_arxiv_doi_prediction_full.csv
Output: data/90k_arxiv_doi_prediction_splits/
"""
import os
...
train_val_df, test_df = train_test_split(
    doi_df,
    test_size=0.2,
    # stratify on has_doi so the 50/50 class balance is preserved in every split
